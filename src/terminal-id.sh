...
# Auto-assign pool - visually distinct emojis for directory assignment
# Curated to avoid similar-looking symbols
_TID_AUTO_POOL="🚀 🌳 ⚙️ ⚡ ☁️ 🗄️ 🐳 📚 🔥 💎 🐹 ❤️ 🏠 📦 🐍 🤖 🦀 ⭐ 🧪 💼 🌸 🌻 🌹 🍀 🌵 🎋 🍄 🌴 🍁 🪷 🌿 🦋 🐝 🐞 🦊 🦁 🐯 🦄 🐙 🦐 🦩 🦚 🦜 🦅 🦉 🦝 🦨 🐸 🐢 🦎 🐠 🐡 🦈 🐬 🐋 🐧 🦔 🐿️ 🦫 🦦 🦥 🐘 🦏 🐪 🍎 🍊 🍋 🍉 🍓 🍑 🥝 🍍 🥥 🥑 🌽 🥕 🥦 🍆 🌶️ 🧁 🍩 🎂 🍫 🍭 🍯 🍿 🧀 🥨 🥐 🍞 🎪 🎭 🎨 🎯 🎲 🎳 🎸 🎺 🎻 🥁 🎹 🎷 🎤 🎧 🎬 🎮 🕹️ 🎰 🚂 ⛵ 🚁 🎠 🎡 🎢 🏖️ 🏔️ 🏕️ 🏜️ 🌋 🗽 🏰 ⛩️ 🕌 🎁 🏆 🎖️ 🧩 🪁 🎈 🧸 🪃 🛸 🧲 💡 🏮 🔬 🔭 💊 🩺 🧬 🦠 ⚗️ 📡 🛰️ 🧭 ⏰ 🌡️ ⚖️ 🔧 🔨 🪚 🧰 💈 🪟 🪑 🛁 🧹 🪣 ⚽ 🏀 🏈 🎱 🏸 🥊 ⛳ ⛸️ 🎣 🛹"

# Count icons in auto pool
_TID_AUTO_POOL_COUNT=168
