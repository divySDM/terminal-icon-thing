...
# Auto-assign pool - large set of visually distinct emojis for directory assignment
# Categories: named identities, nature, animals, food, activities, objects, symbols (~200 icons)
_TID_AUTO_POOL="🚀 🌳 ⚙️ ⚡ ☁️ 🗄️ 🐳 📚 🔥 💎 🐹 ❤️ 🏠 📦 🐍 🤖 🦀 ⭐ 🧪 💼 🌸 🌺 🌻 🌷 🌹 🍀 🌵 🎋 🎍 🍄 🌴 🌾 🍁 🍂 🪷 🪻 🪸 🌼 🌱 🌿 🦋 🐝 🐞 🦊 🦁 🐯 🦄 🐙 🦑 🦐 🦩 🦚 🦜 🦢 🦅 🦆 🦉 🐺 🦝 🦨 🐸 🐢 🦎 🐠 🐟 🐡 🦈 🐬 🐋 🦭 🐧 🦔 🐿️ 🦫 🦦 🦥 🐘 🦏 🦛 🐪 🍎 🍊 🍋 🍇 🍉 🍓 🫐 🍑 🥝 🍍 🥥 🥑 🌽 🥕 🧄 🧅 🥦 🍆 🌶️ 🫑 🧁 🍩 🍪 🎂 🍰 🍫 🍬 🍭 🍯 🥧 🍿 🧇 🥞 🧀 🥨 🥐 🍞 🥖 🥯 🫓 🎪 🎭 🎨 🎯 🎲 🎳 🎸 🎺 🎻 🥁 🎹 🪘 🎷 🪗 🎤 🎧 🎬 🎮 🕹️ 🎰 🚂 ⛵ 🚁 🎠 🎡 🎢 ⛱️ 🏖️ 🏔️ 🗻 🏕️ 🏜️ 🌋 🗽 🗼 🏰 🛕 ⛩️ 🕌 🛖 🔮 🎀 🎁 🏆 🎖️ 🧩 🪁 🎈 🎏 🪆 🧸 🪀 🪃 🛸 🧲 💡 🔦 🏮 🪔 🧿 🔬 🔭 💊 🩺 🩻 🧬 🦠 ⚗️ 🧫 📡 🛰️ 🧭 ⏰ ⏳ 🌡️ ⚖️ 🔧 🔨 ⛏️ 🪚 🔩 🪛 🧰 🪤 💈 🪞 🪟 🛋️ 🪑 🚿 🛁 🪠 🧴 🧷 🧹 🧺 🧻 🪣 ⚽ 🏀 🏈 ⚾ 🥎 🎾 🏐 🏉 🥏 🎱 🏓 🏸 🥊 🥋 ⛳ ⛸️ 🎣 🎽 🛹 🛼"

# Count icons in auto pool
_TID_AUTO_POOL_COUNT=238
